...
const GraficoDeSubsetoresHighcharts = dynamic(
  () => import('@/components/graficos/subsetores/GraficoDeSubsetoresHighcharts'),
  { ssr: false }
);
    ...
    <div id="Dashboard">
      ...
      <div className="container w-full mx-auto pt-20 mt-10 xl:mt-0">
        <div className="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
          ...
          <GraficoDeSubsetoresHighcharts tipoDeInvestimento={1} />
          <GraficoDeSubsetoresHighcharts tipoDeInvestimento={2} />
        </div>
      </div>
    </div>
  );
